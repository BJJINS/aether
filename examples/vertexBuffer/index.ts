...
const uniformOurBufferSize = 4 * 4 + 2 * 4;
...
for (let i = 0; i < kNumObjects; i++) {
  uniformOurValue.set([rand(0, 1), rand(0, 1), rand(0, 1)], i * 4 + 0);
  uniformOurValue.set([rand(-1, 1), rand(-1, 1)], i * 4 + 2);
...
pass.setVertexBuffer(1, uniformOurBuffer);
pass.setVertexBuffer(2, uniformOtherBuffer);
